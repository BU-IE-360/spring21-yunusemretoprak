...
```{r}
USDlvl <- read.xlsx("C:\\Users\\Yunus Emre TOPRAK\\Desktop\\360\\USDlevel.xlsx")
...
```{r}
rsv <- read.xlsx("C:\\Users\\Yunus Emre TOPRAK\\Desktop\\360\\CentralBankReserve.xlsx") 
...
```{r}
MPP <-  read.xlsx("C:\\Users\\Yunus Emre TOPRAK\\Desktop\\360\\MedicalProducts.xlsx") 
